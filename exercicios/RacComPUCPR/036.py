...
#Linhas 8 a 14: Caso contrário, encontramos a primeira ocorrência da nota mais baixa e a removemos usando o método pop().
...
#Veja que neste exemplo verificamos se a maior ou menor nota aparece mais de uma vez na lista, uma vez que o método remove apaga somente a primeira ocorrência daquele elemento. Assim, precisamos percorrer toda a lista, buscando a primeira ocorrência da respectiva nota para ser removida pela função pop, a qual usa o índice do elemento para isso.